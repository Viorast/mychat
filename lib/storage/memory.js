// lib/storage/memory.js - PERSISTENT SINGLETON FIX
...
class MemoryStorage {
  ...
  init() {
    // Initialize with some sample data if the store is empty
...
// ✅ FIXED: Use global object to ensure a single instance across hot reloads
