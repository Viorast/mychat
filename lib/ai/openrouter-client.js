...
const buildContentParts = (prompt, image) => {
    ...
    if (image && image.base64 && image.mimeType) {
        ...
        // ✅ CRITICAL FIX: OpenRouter SDK expects image_url as STRING, not object!
        // Previous (WRONG): image_url: { url: base64Data }
        // Correct (NEW): image_url: base64Data
        // See: https://openrouter.ai/docs/multimodal
        parts.push({
            type: "image_url",
            image_url: base64Data  // Direct string, NOT {url: ...}
        });
